 ...
 */
fun myProfile() {
var namadepan : String = "Hafara"
    var namabelakang : String = "Putri"
    var umur : Number = 21
    var status : Boolean = false
    println("namadepan = $namadepan")
    println("namabelakang = $namabelakang")
    println("umur = $umur")
    println("jomblo atau tidak = $status")
}
 ...
 */
fun myGroup(): String {
val daftaranggota = arrayOf ("Didin", "kepin", "nanda", "Mikais", "Peja")
    var namanama : String = ""
    for (i in 0..daftaranggota.size-1){
        namanama = namanama + "\n" + (i + 1) + "." + daftaranggota [i]
    }
    return namanama
}
...
fun totalMember(): Int {
    ...
    val countOfGroup = 5
var jumlahmentor = mentor.size
    var jumlah = jumlahmentor + countOfGroup
    return jumlah
...
fun main() {
     ...
     *
     */
    groupDetail(3, listOf("I Gusti Ngurah Adi Permana", "Kevin Nathaniel", "Ananda BL Samudra", "Mikais RT", "Hafara Putri"), "Afternoon")
